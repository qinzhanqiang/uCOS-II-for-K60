...
static  void  OS_InitEventList(void);           //对事件控制块进行初始化
...
*/
#if (OS_EVENT_EN)
INT8U  OS_EventTaskRdy (OS_EVENT  *pevent,              //将一个处于等待状态的任务进入就绪状态
                        void      *pmsg,
                        INT8U      msk,
                        INT8U      pend_stat)
{
...
*/
#if (OS_EVENT_EN)
void  OS_EventTaskWait (OS_EVENT *pevent)                           //将一个任务处于等待状态时调用
{
    INT8U  y;
