...
* 
*
* void  *OSMboxAccept (OS_EVENT *pevent);                       //当请求邮箱失败时准许任务不进入等待状态而是继续运行
* 
* OS_EVENT  *OSMboxCreate (void *pmsg);                         //创建一个消息邮箱
* 
* void  *OSMboxPend (OS_EVENT  *pevent,
                   INT32U     timeout,
                   INT8U     *perr);                            //任务调用该函数请求邮箱
* 
* INT8U  OSMboxPost (OS_EVENT  *pevent,
                   void      *pmsg);                            //任务通过调用该函数向消息邮箱发送信息
* INT8U  OSMboxPostOpt (OS_EVENT  *pevent,
                      void      *pmsg,
                      INT8U      opt);                          //通过广播的方式向事件等待任务表中的所有任务发送信息
* 
...
* INT8U  OSMboxQuery (OS_EVENT      *pevent,
                    OS_MBOX_DATA  *p_mbox_data);                //查询邮箱的当前状态
* 
*  
*********************************************************************************************************/
