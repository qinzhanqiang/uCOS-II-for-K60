...
* 本文件定义的函数有：
*
* void  OSTimeDly (INT32U ticks）;              //使当前任务延时（暂停）一段时间，并进行一次任务调度
* INT8U  OSTimeDlyHMSM (INT8U   hours,          //以时、分、秒、毫秒为参数的延时函数                  
*                       INT8U   minutes,        
*                       INT8U   seconds,
*                       INT16U  ms);
* INT8U  OSTimeDlyResume (INT8U prio);          //取消任务延时，进入就绪状态
* INT32U  OSTimeGet (void);                     //获取系统时间
* void  OSTimeSet (INT32U ticks)                //设置系统时间
*
*********************************************************************************************************/
